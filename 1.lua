...
Fatality.GlobalUIScales = {};
function Fatality:SetGlobalDPIScale(scale)
	for _, uiScale in pairs(Fatality.GlobalUIScales) do
		if typeof(uiScale) == "Instance" and uiScale:IsA("UIScale") then
			uiScale.Scale = scale
		end
	end
end
...
function Fatality:CreateElements(Parent : Frame , ZIndex : number , Event : BindableEvent,SearchAPI: {Path: string,Memory : (name:string) -> any}) : Elements
	...
	function elements:AddSlider(Config: Slider)
		...
		Slider.Size = UDim2.new(1, -25, 0, 20)
		...
		ValueFrame.BorderSizePixel = 0
		ValueFrame.Position = UDim2.new(1, -3, 0.5, 0)
		ValueFrame.Size = UDim2.new(0, 65, 0.75, 0)
		ValueFrame.ZIndex = ZIndex + 2
...
function Fatality:CreateConfigWindow(Root: ScreenGui , Fatal , Button: ImageButton)
	...
	local ConfigUIScale = Instance.new("UIScale")
	ConfigUIScale.Parent = ConfigWindowFrame
	ConfigUIScale.Scale = 1
	table.insert(Fatality.GlobalUIScales, ConfigUIScale)
...
function Fatality.new(Window: Window)
	...
	table.insert(Fatality.GlobalUIScales, FatalFrameUIScale)
	...
	do
		...
		local SearchUIScale = Instance.new("UIScale")
		SearchUIScale.Parent = SearchFrame
		SearchUIScale.Scale = 1
		table.insert(Fatality.GlobalUIScales, SearchUIScale)
...
function Fatality:CreateNotifier(): Notifier
	...
	local NotifierUIScale = Instance.new("UIScale")
	NotifierUIScale.Parent = layout
	NotifierUIScale.Scale = 1
	table.insert(Fatality.GlobalUIScales, NotifierUIScale)
